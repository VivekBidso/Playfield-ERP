...
- ~~CPC Module Restructure~~ ✅ March 15, 2026 (Forecast-driven planning, Inventory in Schedule Pending, 3-tab menu)
...
- `dispatch_lots` - Dispatch lots (UPDATED - supports multi-line, readiness tracking)
- `dispatch_lot_lines` - Line items for dispatch lots (NEW)
