...
async def receive_purchase_order(po_id: str, line_id: str, quantity_received: float):
    """Record receipt of PO line items"""
...
async def get_dispatches(
    ...
    """Get dispatches with optional filters"""
    query = {}
    if branch:
        query["branch"] = branch
    if buyer_id:
...
@api_router.put("/dispatches/{dispatch_id}/ship")
...
@api_router.put("/dispatches/{dispatch_id}/deliver")
